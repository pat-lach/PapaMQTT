...
docker run --rm -it -p 1883:1883 -p 7001:9001 -v "${ROOT_MOSQUITTO}/config":/mosquitto/config -v "${ROOT_MOSQUITTO}/data":/mosquitto/data -v "${ROOT_MOSQUITTO}/log":/mosquitto/log eclipse-mosquitto
